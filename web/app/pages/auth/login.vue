...
onMounted(async () => {
  ...
  // Init crypto with public key from config
  ...
  <div>
    <GlassCard class="p-8">
      ...
      <div class="text-center mb-7">
        ...
        <h2 class="text-xl font-semibold text-text-primary">{{ t('auth.login') }}</h2>
        <p class="text-xs text-text-tertiary mt-1">{{ t('auth.welcomeBack') || '欢迎回来，请登录您的账户' }}</p>
      </div>
